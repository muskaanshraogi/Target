...
const generateRoll = (div) => {
  ...
  if (div.slice(0, 2) === "SE") roll = "2";
  else if (div.slice(0, 2) === "TE") roll = "3";
  else if (div.slice(0, 2) === "BE") roll = "4";

  roll += "3";

  if (div.slice(2, 4) === "09") roll += "1";
  else if (div.slice(2, 4) === "10") roll += "2";
  else if (div.slice(2, 4) === "11") roll += "3";
