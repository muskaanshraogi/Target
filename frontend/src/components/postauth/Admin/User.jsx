import {
  ...
  export default function User(props) {
    ...
    const handleDelete = () => {
        ...
        Axios.post(
          `${process.env.REACT_APP_HOST}/api/faculty/delete/${
          ...
          <div style={{ paddingTop: "3%" }}>
            ...
            >
              <Grid item xs={4}>
                <Paper className={classes.paper}>
                  Registration ID : <b style={{ color: "#E50058" }}>{user[0].reg_id}</b>
                </Paper>
              </Grid>
              <Grid item xs={4}>
                <Paper className={classes.paper}>
            ...
            <Grid item spacing={2} style={{ marginTop: '1%' }}>
                ...
                <TableContainer component={Paper}>
                    ...
                    <TableHead>
                        <TableRow>
                        <TableCell align="center" className={classes.title}>ID</TableCell>
                        <TableCell align="center" className={classes.title}>Subject</TableCell>
                    ...
                    <TableBody>
                        ...
                        <TableRow key={subject.subId}>
                            ...
                            <TableCell align="center" className={classes.text}>{subject.roleName.split(" ")[1]}</TableCell>
            ...
            >
              ...
              <DialogActions>
                <Button onClick={() => setOpenDelete(!openDelete)} color="primary">
                  No
                </Button>
